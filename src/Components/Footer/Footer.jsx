...
const Footer = () => {
    return (
        <div>
            <footer className="footer px-12 py-10 bg-base-200 text-base-content">
                <div>
                    <span className="footer-title">Products Category</span>
                    <a className="link link-hover">Sports car toy</a>
                    <a className="link link-hover">truck toy</a>
                    <a className="link link-hover">regular car toy</a>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Little Joyful Land Ltd. <br />Providing reliable tech since 2023</p>
                </div>
